...
# This generates the following GIS related files:
#
# - shp file for the feature locations using ogr2ogr on the command line. Requires
#   CSV file generated by docgen_csv.
# - shp file for the extent of each region using ogr2ogr on the command line.
# - A ZIP file containing the two shp files (and other associated files) from above.
# - Mapserver files for each supported map type.
